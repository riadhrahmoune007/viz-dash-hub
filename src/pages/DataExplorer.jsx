...
const DataExplorer = () => {
  ...
  const { dataOverview, isUsingDefaultData, isLoading, supbaseConnected } = useData();
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="p-6 overflow-y-auto">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-red-700">
                    <strong>Database connection error:</strong> Unable to connect to Supabase. Please check your Supabase URL and API key configuration.
                  </p>
                </div>
              </div>
            </div>
          ...
          {isUsingDefaultData && !isLoading && supbaseConnected && (
